...
#line 181 "grammar.tab.hh"
  ...
  public:
    ...
    parser (yy::parser::semantic_type &ast_yyarg);
    virtual ~parser ();
  ...
  private:
    ...
    // User arguments.
    yy::parser::semantic_type &ast;
  };


} // yy
#line 715 "grammar.tab.hh"
